...
int front(List L);         // Returns front element (precondition: length() > 0)
int back(List L);          // Returns back element (precondition: length() > 0)
int get(List L);           // Returns the cursor element (precondition: length() > 0, index() >= 0)
int equals(List A, List B);  // Returns 1 if A and B contain the same sequence of elements

void clear(List L);        // Resets L to its original empty state
void set(List L, int x);   // Overwrites cursor element with x
...
void prepend(List L, int x); // Inserts new element before front
void append(List L, int x);  // Inserts new element after back
void insertBefore(List L, int x); // Inserts element before cursor
void insertAfter(List L, int x);  // Inserts element after cursor
...
List copyList(List L);  // Returns a new list that is a copy of L
